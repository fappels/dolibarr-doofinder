...
/**
 *	\file       htdocs/doofinder/template/doofinderindex.php
 *	\ingroup    doofinder
 *	\brief      Home page of doofinder top menu
 */
...
$langs->loadLangs(array("doofinder@doofinder"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->doofinder->read) accessforbidden();
...
llxHeader("",$langs->trans("DoofinderArea"));

print load_fiche_titre($langs->trans("DoofinderArea"),'','doofinder.png@doofinder');
...
// Draft MyObject
if (! empty($conf->doofinder->enabled) && $user->rights->doofinder->read)
{
	$langs->load("orders");
