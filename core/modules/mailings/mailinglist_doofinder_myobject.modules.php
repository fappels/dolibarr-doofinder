...
dol_include_once("/doofinder/class/myobject.class.php");


/**
 * mailing_mailinglist_doofinder
 */
class mailing_mailinglist_doofinder_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_doofinder_myobject';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('doofinder',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/doofinder/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_doofinder_myobject.modules.php: mailing ".$num." targets found");
