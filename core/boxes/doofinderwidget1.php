...
/**
 * \file    modulebuilder/template/core/boxes/doofinderwidget1.php
 * \ingroup doofinder
 * \brief   Widget provided by Doofinder
 *
 ...
 */
class doofinderwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "doofinderbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "doofinder@doofinder";
	 ...
	 */
	public $depends = array('doofinder');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->doofinder->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/doofinder/class/doofinder.class.php";

		// Populate the head at runtime
		$text = $langs->trans("DoofinderBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_doofinder@doofinder',
