...
/**
 * \file    test/functional/DoofinderFunctionalTest.php
 * \ingroup doofinder
 ...
 *
 * @package Testdoofinder
 */
class DoofinderFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDoofinder')->click();
		} else {
			// Disable the module
			$this->byHref('modDoofinder')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/doofinder/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('doofinder/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/doofinder/admin/about.php');
		$this->authenticate();
		return $this->assertContains('doofinder/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('doofinderwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoofinder_DoofinderTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoofinder_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
